...
class PSPNet(BaseModel):
    def __init__(self, num_classes, model, config, in_channels=3, use_aux=True, freeze_bn=False, freeze_backbone=False):
        ...
        self.master_branch = nn.Sequential(
            _PSPModule(m_out_sz, bin_sizes=[8, 16, 32, 64], norm_layer=norm_layer),#####1*1 size，change to [16*16, 32*32, 48*48, 64*64]?
