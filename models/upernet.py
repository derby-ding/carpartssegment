...
class UperNet(BaseModel):
    ...
    def __init__(self, num_classes, model, config, in_channels=3, use_aux=True, fpn_out=256, freeze_bn=False, freeze_backbone=False, **_):
        super(UperNet, self).__init__()

        feature_channels = [256, 512, 1024, 2048]
        self.backbone = ResNet(model, in_channels)
